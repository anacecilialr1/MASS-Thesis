...
The transition probability of Equation~\ref{eq:drw_transition} follows from solving the Ornstein-Uhlenbeck stochastic differential equation. Here $X_t$ denotes the flux process $f(t)$ of Equation~\ref{eq:drw_sde}, rewritten using the standard Itô notation $dX_t$ and the damping rate $\theta = 1/\tau$:
\begin{equation}
    \label{eq:app_ou}
